function [det_reciprocalXgrid, det_reciprocalYgrid, det_reciprocalZgrid] = non_orthogonal_coordinates(S)
...
SrecipXgrid = S.N1grid;
SrecipYgrid = S.N2grid;
SrecipZgrid = S.N3grid;
